...
import { Breadcrumb, Segment, Header, Message, Button, Loader } from 'semantic-ui-react';
import { InputField, Form } from '~/form/formWrapper';
import { PropsInner as Props } from './createIdentity';

const CreateIdentity: React.SFC<Props> = (props) => (
    <Segment.Group>
        <Segment>
            <Header as="h2">
                <Breadcrumb size="huge">
                    ...
                    <Breadcrumb.Section active={true}>Create identity</Breadcrumb.Section>
                </Breadcrumb>
            </Header>
        </Segment>
        <Segment>
            <Message>
                <p>
                    This wizzard creates new ONT ID with private key and encrypt it with provided
